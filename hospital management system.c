...
char string[20];
typedef struct hospital quience;
...
void main()
{
	...
	fflush(stdin);gotoxy(28,9);
	scanf("%[^\n]",date2);
	if((date2[4]!='/')||(date2[7]!='/')||(date2[5]>'3')||(date2[8]>'3'))
	{
		clrscr();
		mainscreen();
		gotoxy(22,10);textcolor(4+128);
		cprintf("Wrong Entry");
		goto label3;
	}
	clrscr();
	...
	textcolor(15);
	lowvideo();gotoxy(7,8);textcolor(14);
	cprintf("Enter the corresponding no");gotoxy(7,12);textcolor(10);
	cprintf("1.Add new patient record");gotoxy(7,14);
	cprintf("2.Search  or edit record");gotoxy(7,16);
	cprintf("3.Know the records of patients");gotoxy(7,18);
	cprintf("4.Delete the records");gotoxy(7,20);
	cprintf("5.Exit from the program");gotoxy(10,21);
	fflush(stdin);
	scanf("%c",&d);
	switch(d)
	{
		case '1':
...

			{
				...
				{
				while(fread(&p,sizeof(quience),1,fp))
				s=1+p.sn;
				}
				fclose(fp);
			}
		...
		case '4':
			{
				...
				while(fread(&p,sizeof(quience),1,fp))
					if(p.sn!=y)
					fwrite(&p,sizeof(quience),1,f1);
				clrscr();
				mainscreen();
				fseek(fp,(y-1)*sizeof(quience),SEEK_SET);
				fread(&p,sizeof(quience),1,fp);
				print();
				edit1();
				gotoxy(25,46);
		...
		case '3':
			{       label6:
				clrscr();
				mainscreen();
				gotoxy(35,22);textcolor(12);
				cprintf("Enter the corresponding no");gotoxy(35,24);textcolor(3);
				cprintf("1.Records of patients in alphabatecal order");gotoxy(35,26);
				cprintf("2.Records of Emergency patients");gotoxy(35,28);
				cprintf("3.Records of O.P.D. patients");gotoxy(35,30);
				cprintf("4.Recordsin paricular date");gotoxy(35,32);
				cprintf("5.Return to main menu");gotoxy(38,34);
				fflush(stdin);
				scanf("%c",&d);
				switch(d)
				{
				case '1':
					{
					 ...
					 fseek(fp,0,SEEK_END);
					 tsz=ftell(fp);
					 n=(int)(tsz/sizeof(quience));
					 for(i=0;i<(n-1);i++)
					 {
						for(a=i+1;a<n;a++)
						{
						fseek(fp,i*sizeof(quience),SEEK_SET);
						fread(&p,sizeof(quience),1,fp);
						fseek(fp,a*sizeof(quience),SEEK_SET);
						fread(&q,sizeof(quience),1,fp);
						if(strcmp(p.name,q.name)>0)
							{
							fseek(fp,i*sizeof(quience),SEEK_SET);
							fwrite(&q,sizeof(quience),1,fp);
							fseek(fp,a*sizeof(quience),SEEK_SET); fflush(stdin);
							fwrite(&p,sizeof(quience),1,fp);
							}
						}
					}
					rewind(fp);
					...
					gotoxy(35,35);textcolor(60);
					cprintf("Press");textcolor(15+60);
					cprintf(" `Enter' ");    textcolor(60);
					cprintf("to continue");
					getch();
					while(fread(&p,sizeof(quience),1,fp))
					{
			...
			case '2':
				...
				gotoxy(27,38);textcolor(10);
				cprintf("Press");textcolor(28+100);
...
{
	int i;
	gotoxy(47,23);textcolor(6);
	cprintf("Specialists:");
	gotoxy(47,24);textcolor(15);
	cprintf("---------------");
	gotoxy(70,23);textcolor(6);
	cprintf("Room No:");
	gotoxy(70,24);textcolor(15);
	cprintf("----------");
	gotoxy(47,26);textcolor(5);
	cprintf("1.General Physician");
	gotoxy(70,26);textcolor(7);
	cprintf("201,202");
	gotoxy(47,28);textcolor(5);
	cprintf("2.E.N.T");
	gotoxy(70,28);textcolor(7);
	cprintf("302");
	gotoxy(47,30);textcolor(5);
	cprintf("3.Cardiologist");
	gotoxy(70,30);textcolor(7);
	cprintf("509");
	gotoxy(47,32);textcolor(5);
	cprintf("4.Dermatologist");
	gotoxy(70,32);textcolor(7);
	cprintf("406");
	gotoxy(47,34);textcolor(5);
	cprintf("5.Gastroenterologist");
	gotoxy(70,34);textcolor(7);
	cprintf("308");
	gotoxy(47,36);textcolor(5);
	cprintf("6.Pediatrician");
	gotoxy(70,36);textcolor(7);
	cprintf("207");
	gotoxy(47,38);textcolor(5);
	cprintf("7.EYE Specialist");
	gotoxy(70,38);textcolor(7);
	cprintf("102");
	gotoxy(47,40);textcolor(5);
	cprintf("8.Nephrologist");
	gotoxy(70,40);textcolor(7);
	cprintf("109");
	gotoxy(47,42);textcolor(5);
	cprintf("9.General Surgeon");
	gotoxy(64,42);textcolor(7);
	cprintf("407,408,412,413");
	gotoxy(47,44);textcolor(5);
	cprintf("10.Accupuncturist");
	gotoxy(70,44);textcolor(7);
	cprintf("123,119");
	textcolor(15);
	for(i=25;i<=44;i++)
	{
...
void print()
{
	gotoxy(41,20);  textcolor(7);
	cprintf("DISPLAYING RECORDS");
	gotoxy(40,21);textcolor(15);
	cprintf("--------------------");
	gotoxy(6,24);textcolor(2);
	cprintf("Patient no:");gotoxy(17,24);textcolor(11);
	cprintf("%d",p.sn);gotoxy(6,25);textcolor(2);
	cprintf("Name:");gotoxy(11,25);textcolor(11);
	cprintf(" %s",p.name);gotoxy(6,26);textcolor(2);
	cprintf("Address:");gotoxy(15,26);textcolor(11);
	cprintf(" %s",p.address);gotoxy(6,27);textcolor(2);
	cprintf("Age:");gotoxy(11,27);textcolor(11);
	cprintf("%d",p.age);gotoxy(6,28);textcolor(2);
	cprintf("Sex:");gotoxy(10,28);textcolor(11);
	cprintf(" %c",p.ch);gotoxy(6,29);textcolor(2);
	cprintf("Date of Reg.:");gotoxy(20,29);textcolor(11);
	cprintf("%s",p.date);gotoxy(6,30);textcolor(2);
	cprintf("Room no:");gotoxy(13,30);textcolor(11);
	cprintf(" %d",p.roomno);gotoxy(6,31);textcolor(2);
	cprintf("Department:");gotoxy(17,31);textcolor(11);
	cprintf(" %s",p.department);gotoxy(6,32);textcolor(2);
	cprintf("Category:");gotoxy(15,32);textcolor(11);
...
{
	int i,k;
	gotoxy(6,34);textcolor(2);
	cprintf("Details:");gotoxy(14,34);textcolor(11);
	cprintf(" %s",p.recommendation);gotoxy(6,36);textcolor(4);
	cprintf("Press");textcolor(15+128);
...
void switch1()
{
	...
	char v;
	label2:
	gotoxy(47,25);textcolor(11);
	cprintf("Enter");gotoxy(47,27);
	cprintf("1.Add Details");
	gotoxy(47,29);
	cprintf("2.Change Specialist");
	gotoxy(47,31);
	cprintf("3.Deposit balance");gotoxy(47,33);
	cprintf("4.Add test");
	gotoxy(47,35);
	...
	switch(x)
	{
		case 1:
			...
			clrscr();
			mainscreen();
			gotoxy(50,38);  textcolor(7);
			cprintf("ADDING DETAILS");
			gotoxy(49,39);textcolor(15);
			cprintf("----------------");
			gotoxy(43,40);
			textcolor(2);
			cprintf("Previous Details:");
			gotoxy(60,40);textcolor(11);
			cprintf(" %s ",p.recommendation);
			gotoxy(43,41);textcolor(2);
		...
		case 2:
			...
			mainscreen();
			displaydepartment();
			gotoxy(28,18);  textcolor(60);
			cprintf("CHANGING SPECIALIST");
			gotoxy(27,19);textcolor(15);
			cprintf("---------------------");
			gotoxy(5,20);
			textcolor(2);
		...
		case 3:
		      {
		       clrscr();
		       mainscreen();
		       gotoxy(49,38);  textcolor(7);
		       cprintf("DEPOSITING MONEY");
		       gotoxy(48,39);textcolor(15);
		       cprintf("---------------------");
		       gotoxy(47,40);
		       textcolor(2);
...
void editrecord()
{
   ...
   gotoxy(35,23);
	...
	if((p.sn==y)||(strcmp(p.name,string)==0))
		{
			print();
			edit1();gotoxy(43,15);textcolor(9);
...
void displaytest()
{       int i;
	gotoxy(50,10);textcolor(28);
	cprintf("::ADDING SERVICES::");gotoxy(45,11);textcolor(28);
	cprintf("----------------------------");
	gotoxy(9,10);textcolor(28);
	cprintf(":PRICE LIST:");
	textcolor(28);
	gotoxy(4,11);
	cprintf("---------------------");
	gotoxy(5,14);textcolor(28);
	cprintf("1.X-Ray");
	gotoxy(30,14);textcolor(28);
	cprintf("Rs. 300.00");
	gotoxy(5,16);textcolor(28);
	cprintf("2.Ultra-sound");
	gotoxy(30,16);textcolor(28);
	cprintf("Rs. 500.00");
	gotoxy(5,18);textcolor(28);
	cprintf("3.C.T.Scan");
	gotoxy(30,18);textcolor(28);
	cprintf("Rs.1800.00");
	gotoxy(5,20);textcolor(28);
	cprintf("4.TC,DC,HB");
	gotoxy(30,20);textcolor(28);
	cprintf("Rs.  90.00");
	gotoxy(5,22);textcolor(28);
	cprintf("5.Urine R/E");
	gotoxy(30,22);textcolor(28);
	cprintf("Rs.  80.00");
	gotoxy(5,24);textcolor(28);
	cprintf("6.Blood C/S");
	gotoxy(30,24);textcolor(28);
	cprintf("Rs. 250.00");
	gotoxy(5,26);textcolor(28);
	cprintf("7.Biliribin D/T");
	gotoxy(30,26);textcolor(28);
	cprintf("Rs. 200.00");
	gotoxy(5,28);textcolor(28);
	cprintf("8.Stool Test");
	gotoxy(30,28);textcolor(28);
	cprintf("Rs.  60.00");
	gotoxy(5,30);textcolor(28);
	cprintf("9.Bed Charge");
	gotoxy(30,30);textcolor(28);
	cprintf("Rs. 150.00");
	gotoxy(5,32);textcolor(28);
	cprintf("10.Sugar Test");
	gotoxy(30,32);textcolor(28);
	cprintf("Rs. 400.00");
	textcolor(15);
	for(i=10;i<=46;i++)
	{
...
void mainscreen()
{
	...
	gotoxy(26,4);textcolor(3);
	cprintf("QUIENCE HOSPITAL");
	gotoxy(26,6);textcolor(50);
	cprintf("DORATANA,JESSORE");
	gotoxy(27,7); textcolor(15);
   gotoxy(45,3);textcolor(28);
   cprintf("programmer by Md.Shouvikur Rahman");
   gotoxy(59,4);textcolor(28);
   cprintf("id= 20163034011");
}
